...
export interface ICoinByIdRes extends IDataRes {
        currentData: ICoinById
        data: ICoinById
}
export type CoinByIdType = {
    id: string,
...
export interface ICoinById {
  ...
  export interface MarketData {
    current_price: PriceOrPercent;
    total_value_locked?: null;
    mcap_to_tvl_ratio?: null;
    fdv_to_tvl_ratio?: null;
    roi?: null;
    ath: PriceOrPercent;
    ath_change_percentage: PriceOrPercent;
    ath_date: AthDateOrAtlDate;
    atl: PriceOrPercent;
    atl_change_percentage: PriceOrPercent;
    atl_date: AthDateOrAtlDate;
    market_cap: PriceOrPercent;
    market_cap_rank: number;
    fully_diluted_valuation: PriceOrPercent;
    total_volume: PriceOrPercent;
    high_24h: PriceOrPercent;
    low_24h: PriceOrPercent;
    ...
    price_change_24h_in_currency: PriceOrPercent;
    price_change_percentage_1h_in_currency: PriceOrPercent;
    price_change_percentage_24h_in_currency: PriceOrPercent;
    price_change_percentage_7d_in_currency: PriceOrPercent;
    price_change_percentage_14d_in_currency: PriceOrPercent;
    price_change_percentage_30d_in_currency: PriceOrPercent;
    price_change_percentage_60d_in_currency: PriceOrPercent;
    price_change_percentage_200d_in_currency: PriceOrPercent;
    price_change_percentage_1y_in_currency: PriceOrPercent;
    market_cap_change_24h_in_currency: PriceOrPercent;
    market_cap_change_percentage_24h_in_currency: PriceOrPercent;
    total_supply: number;
    max_supply?: null;
    circulating_supply: number;
    last_updated: string;
  }
  export interface PriceOrPercent {
    aed: number;
    ars: number;
    aud: number;
    bch: number;
